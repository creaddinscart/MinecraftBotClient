...
_translations = {
    "zh": {
        "banner_title": "Minecraft Bot Client (MBC) v1.0.0",
        "banner_sub1": "支持版本 1.8 - 1.21.1",
        ...
        "label_chat": "[聊天] {text}",
        "label_sent": "{text}",
        "label_prompt_exit": "输入消息后按 Enter 发送，'exit' 退出",
    ...
    "en": {
        "banner_title": "Minecraft Bot Client (MBC) v1.0.0",
        "banner_sub1": "Supporting versions 1.8 - 1.21.1",
        ...
        "label_sent": "{text}",
        "label_prompt_exit": "Type message and press Enter to send, 'exit' to quit",
        "label_prompt_input": "[{user}]: ",
        "label_command_exit": "exit",
        "label_command_help": "help",
        "label_command_settings": "/settings",
